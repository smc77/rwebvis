...
wv <- new.webvis(root=pv.panel(width=800, height=445, right=60, top=20))
wheat <- new.webvis(root=pv.area(wv, data=wheat, interpolate="step-after", bottom=0, y.name="wheat", x.name="year", fill.style="#aaa", stroke.style="#999"))
wheat <- wheat + pv.rule()
wv <- wv + wheat
